...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning vartika"<<endl;
        string phrase = "Good Morning vartika";
        ...
        cout<< "Good Afternoon vartika"<<endl;
        string phrase = "Good Afternoon vartika";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening vartika"<<endl;
        string phrase = "Good Evening vartika";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    do
    {
        ...
        if(password=="vartika")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you vartika...."<<endl<<endl;

                string phrase = "How can i help you vartika";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello vartika....."<<endl;
                    string phrase = "Hello vartika";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by vartika !!!"<<endl;
                    string phrase = "I'm a personal assistant created by vartika !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
    ...
    //             {
    //                 cout<<"Good Bye vartika, see you soon!"<<endl;
    //                 string phrase = "Good Bye vartika, see you soon!";
    //                 string command = "espeak \"" + phrase + "\"";
    //                 const char *charCommand = command.c_str();
    //                 system(charCommand);
    //                 exit(0);
